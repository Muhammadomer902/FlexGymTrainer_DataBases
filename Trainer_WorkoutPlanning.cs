...
{
    public partial class Trainer_WorkoutPlanning : Form
    {
        ...
        public Trainer_WorkoutPlanning(Form prevForm, int trainer_ID)
        {
            InitializeComponent();
        ...
        private void Trainer_WorkoutPlanning_Load(object sender, EventArgs e)
        {
            D1_L1.Visible = false;
            D1_L2.Visible = false;
            D1_L3.Visible = false;
        ...
        {
            connection.Open();
            string query = "select Workout_ID from WorkoutPlan where CreatedBy='" + Trainer_ID + "' Order by Workout_ID DESC";
        ...
        private void NEXT_Click(object sender, EventArgs e)
        {
            if (!check1 && DaysPerWeek.SelectedIndex != -1 && purpose.SelectedIndex != -1)
            {
                ...
                string createrType = "Trainer";
                connection.Open();
                string Query = $"insert into WorkoutPlan(DaysPerWeek,Purpose,CreatedBy,CreaterType,ExperienceRequired) values('{DaysPerWeek.Text}','{purpose.Text}','{Trainer_ID}','{createrType}','{ExpReq.Text}')";
                SqlCommand cmd = new SqlCommand(Query, connection);
                check1 = true;
                cmd.ExecuteNonQuery();
