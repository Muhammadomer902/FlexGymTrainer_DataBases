...
{
    public partial class TrainerDietPlanning : Form
    {
        private Form prevForm;
        private int Trainer_ID;
        private int purpose_idx;
        public TrainerDietPlanning(Form prevForm, int id)
        {
            InitializeComponent();
        ...
        private void TrainerDietPlanning_Load(object sender, EventArgs e)
        {
                    ...
                    case 0:
                        {
                            ...
                            connection.Open();
                            string query1 = $"Insert into DietPlan Values('{Purpose.Text}','{Breakfast}','{Lunch}','{Dinner}',{Trainer_ID},'Trainer')";
